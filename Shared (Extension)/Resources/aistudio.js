class AiStudioProvider extends BaseAIProvider {
    constructor() {
        ...
        this.messageContainerSelector = 'ms-chat-turn';  //  The core, correct selector.  This gets EACH turn (user and AI).
              this.userMessageSelector = '.user-prompt-container .turn-content';   // More specific, better selector.
              this.assistantMessageSelector = '.model-prompt-container .turn-content';  // More specific, better selector.
