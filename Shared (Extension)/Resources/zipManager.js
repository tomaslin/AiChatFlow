...
class ZipManager {
    ...
    static downloadAllWorkspaceFiles(workspaceFiles) {
        ...
        // Process each workspace and its files
        ...
        endView.setUint16(4, 0, true); // Number of this disk
        endView.setUint16(6, 0, true); // Disk where central directory starts
        endView.setUint16(8, totalFiles, true); // Number of central directory records on this disk
        endView.setUint16(10, totalFiles, true); // Total number of central directory records
        endView.setUint32(12, centralDirSize, true); // Size of central directory
        endView.setUint32(16, offset, true); // Offset of start of central directory
        endView.setUint16(20, 0, true); // Comment length
